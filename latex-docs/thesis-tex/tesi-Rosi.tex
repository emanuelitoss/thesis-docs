...
\begin{equation*}
    \left(-\frac{\partial^2}{\partial t^2} + \vec p^2 + m^2 \right) G_\omega(t,t') = \left(-\frac{\partial^2}{\partial t^2} + \omega^2 \right) G_\omega(t,t') = L_\omega G_\omega(t,t') = \delta (t-t')
\end{equation*}
