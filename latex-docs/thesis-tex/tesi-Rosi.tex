...
I conclude with a short description of the status of this work and expectations regard its development.
...
\newline
Further developments involve the calculation of these three points correlator by using faithful sea configurations and setting the right parameters on the input files.
