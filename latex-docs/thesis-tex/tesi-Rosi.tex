...
\begin{acknowledgments}
    ...
    Questi sotto la sua supervisione sono stati estremamente formativi, sia dal punto di vista scientifico ma soprattutto dal punto di vista di approccio alla fisica.
    Grazie.
    \newline\newline
