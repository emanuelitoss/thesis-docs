...
Thus I directly evaluate this correlators:
...
With the symbol $\sim$ I refer to the fact that the two correlators have the same structure, i.e. are {\it similar} from a computational point of view.
