...
\begin{itemize}
    ...
    \item [$\triangleright$] The \textit{twisted mass QCD} (tmQCD) and \textit{Maximally twisted mass QCD} (MtmQCD) described respectively in \ref{sec:tmLQCD} and \ref{sec:max-twist} are introduced to solve the problem of zero-modes.
...
Notice the subscripts $(M_q,0)$ and $(m_q,\mu_q)$.
...
Regarding the positivity of $\text{det}(D)$, \obc\space solve this problem.
...
\newpage
\section{\colv{Qui posso inserire i check fatti e il metodo di analisi dati implementato}}
\noindent
\colg{
    ...
    \begin{enumerate}
        \item Calcolo i correlatori a 2 punti.
            ...
            Dovrebbe andare come un seno iperbolico $\sim \sinh\left(m_K (T-x_4)\right)$.
        \item Per i correlatori a due punti cerco di capire quali sono le regioni in cui ho solamente il contributo asintotico dello stato più leggero.
            Questo mi darà un senso della distanza sorgente-interazione $|x_4-z_4|$ necessaria per eliminare gli altri contributi.
        \item Faccio lo stesso per i correlatori a 3 punti. Stavolta però fisso $z_4 = 1$ e faccio una marea di run per ogni $x_4$ maggiore del {\bf doppio} di tale distanza minima (punto precedente) fino ad arrivare a $x_4 = N_T -1$.
        \item Poi prendo un set delle tre punti con $x_4$ fissato e cerco il plateau per $x_4 - y_4$ e $y_4-z_4$ maggiori del limite di contributi non nulli.
        \item Calcolo tale plateau e lo divido per la due punti fino con $x_4 - z_4$. Ho ottenuto il valore dell'elemento di matrice.
        \item Calcolo tale elemento di matrice al variare delle $x_4$ e dovrebbe venire sempre costante (a meno di contributi superiori da stati più pesanti).
